...
SECRET_KEY = 'django-insecure-j_47h#am!#-h28-d^4ipx*i$)*bcu&+wfb#72&wk3#u5u)-m$('
...
CORS_ALLOWED_ORIGINS = ["http://localhost:5173","http://35.226.26.69"]
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'Daga123',
        'HOST': 'localhost',  # Set to your database server's IP if not local
